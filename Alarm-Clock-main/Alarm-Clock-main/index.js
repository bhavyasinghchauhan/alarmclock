...
const setHrs = document.querySelector("#hours");
const setMins = document.querySelector("#minutes");
...
// Updating the HTML elements with the values
...
// Adding Hours, Minutes, Seconds in Menu
window.addEventListener("DOMContentLoaded", (event) => {
  
  dropDownMenu(1, 12, setHrs);
 
  dropDownMenu(0, 59, setMins);
...
// adding the Event Listener for Setting the Alarm
...
function getInput(e) {
  ...
  const minuteValue = setMins.value;
